...
class MedicalImageDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.transform and self.cross_modality==False:
            ...
            transform = self.choose_transformation("CT")
...
def run_experiment(runs, model, anatomy, augmentation, dataset_size=1.0):
    ...
    #data, labels = load_data("/mnt/data/jstutz/data/brain_np_extended/train_val_set/CT")
    #test_data_in, test_labels_in = load_data("/mnt/data/jstutz/data/brain_np_extended/test_set/CT")
    #test_data_out, test_labels_out = load_data("/mnt/data/jstutz/data/brain_np_extended/test_set/MRI")
    data, labels = load_data("/mnt/data/jstutz/data/bladder_np_divided/CT/to_be_augmented")
    test_data_in, test_labels_in = load_data("/mnt/data/jstutz/data/bladder_np_divided/CT/original")
...
with open("OOD_samples_CT_to_MRI.txt", "w+", encoding="utf-8") as result_file:
    runs = 5
    ood_insgesamt =[]
