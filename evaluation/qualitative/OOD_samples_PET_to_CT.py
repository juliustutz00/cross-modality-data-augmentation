...
def run_experiment(runs, model, anatomy, augmentation, dataset_size=1.0):
    ...
    test_data_out, test_labels_out = load_data("/mnt/data/jstutz/data/bladder_np_divided/CT/original")
...
with open("OOD_samples_PET_to_CT.txt", "w+", encoding="utf-8") as result_file:
    runs = 5
    ood_insgesamt =[]
