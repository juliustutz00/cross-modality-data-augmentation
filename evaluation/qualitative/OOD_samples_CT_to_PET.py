...
def run_experiment(runs, model, anatomy, augmentation, dataset_size=1.0):
    ...
    #test_data_out, test_labels_out = load_data("/mnt/data/jstutz/data/brain_np_extended/test_set/PET")
...
with open("OOD_samples_CT_to_PET.txt", "w+", encoding="utf-8") as result_file:
    runs = 5
    ood_insgesamt =[]
