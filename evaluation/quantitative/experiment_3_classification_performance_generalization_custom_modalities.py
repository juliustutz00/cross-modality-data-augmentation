...
enable_wandb=False
with open("classification_performance_generalization_custom_modalities.txt", "w+", encoding="utf-8") as result_file:
    ...
    '''
    result_file.write("no \r\n")
    modelVisTran_no = vit_b_16(pretrained=False)
    ...
    '''
    result_file.write("imgaug \r\n")
    modelVisTran_imgaug = vit_b_16(pretrained=False)
    ...
    result_file.write("albumentations \r\n")
    modelVisTran_albumentations = vit_b_16(pretrained=False)
    ...
    result_file.write("v2 \r\n")
    modelVisTran_v2 = vit_b_16(pretrained=False)
    ...
    result_file.write("RandAugment \r\n")
    modelVisTran_RandAugment = vit_b_16(pretrained=False)
    ...
    '''
    result_file.write("cross modality \r\n")
    modelVisTran_cross_modality = vit_b_16(pretrained=False)
