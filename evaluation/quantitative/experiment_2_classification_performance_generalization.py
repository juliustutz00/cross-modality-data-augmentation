...
def run_experiment(runs, model, anatomy, augmentation, dataset_size=1.0, generalization_modalities=['CT', 'MRI', 'PET']):
    ...
    mean, std = calculate_mean_std_generalization(train_val_data)
...
runs = 5
dataset_size = 1.0
generalization_modalities = ['CT', 'PET']
enable_wandb=False
with open("classification_performance_generalization.txt", "w+", encoding="utf-8") as result_file:
    ...
    run_experiment(runs, modelResNet_no, "brain", "no", dataset_size, generalization_modalities)
    ...
    run_experiment(runs, modelResNet_cross_modality, "brain", "cross_modality", dataset_size, generalization_modalities)
    ...
    run_experiment(runs, modelVisTran_no, "brain", "no", dataset_size, generalization_modalities)
    ...
    run_experiment(runs, modelVisTran_cross_modality, "brain", "cross_modality", dataset_size, generalization_modalities)
